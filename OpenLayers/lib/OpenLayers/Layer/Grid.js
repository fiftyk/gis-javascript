...
OpenLayers.Layer.Grid = OpenLayers.Class(OpenLayers.Layer.HTTPRequest, {
     ...
     * {String} 如果 <tileOrigin> 属性没有指定, the tile origin 
     *     will be derived from the layer's <maxExtent>.  The corner of the 
     *     <maxExtent> used is determined by this property. 可选值有: "tl" 
     *     (top left), "tr" (top right), "bl" (bottom left), 以及 "br"
     *     (bottom right). 默认为 "bl".
     */
    tileOriginCorner: "bl",
     ...
     * {<OpenLayers.Tile>} 图层用于创建Tile的类.
     */
    tileClass: OpenLayers.Tile.Image,
    
    /**
     * Property: grid
     * {Array(Array(<OpenLayers.Tile>))} OpenLayer.Tile的二维数组.
     */
    grid: null,
    ...
    /** 
     * APIProperty: ratio
     * {Float} 仅在 single-tile 模式下有效, this specifies the 
    ...
    /**
     * APIProperty: buffer
     * {Integer} 仅在 gridded 模式下有效, this specifies the number of 
