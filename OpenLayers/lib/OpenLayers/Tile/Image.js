 ...
 * OpenLayers.Tile.Image的实例用于众多图层的 image tiles 管. 使用 
 * <OpenLayers.Tile.Image> constructor 创建新的 image tiles.
 *
 * 继承自:
 *  - <OpenLayers.Tile>
 */
OpenLayers.Tile.Image = OpenLayers.Class(OpenLayers.Tile, {
    ...
    /** 
     * APIProperty: url
     * {String} image 的URL. 没有默认值. 通过 layer.getURL() 方法设置. 可能在
     *  loadstart 事件监听器中被修改.
     */
    url: null,
    ...
    /** 
     * Property: imgDiv
     * {HTMLImageElement} 该 tile 的 image 标签.
     */
    imgDiv: null,
